...
function Footer() {
  return (
    <div className="footer bg-[#e5fbf1] sticky bottom-0">
      ...
      >
        <div className="left-slogan w-full lg:w-1/2 flex justify-center">
        ...
        <div className="hot-line w-full lg:w-1/2 flex justify-center">
          <div className="border-2 border-[#326e51] w-full flex  justify-evenly rounded-lg h-[100px]">
