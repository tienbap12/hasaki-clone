  ...
  return (
    <div className="container my-1">
      <div className="w-full flex gap-1">
        <div className="slider-left w-2/3 bg-slate-300 h-64 relative group">
          <Carousel
        ...
        <div className="w-1/3 flex flex-col gap-1 ">
          <div className="banner-right h-32 relative">
            <img src={Banner1} alt="" />
          </div>
          <div className="banner-right relative h-32">
            <img src={Banner2} alt="" />
          </div>
        </div>
      </div>
      {allCategoryLoading ? (
        ...
        <div className="categories w-full py-2 flex justify-between px-4 ">
      ...
      <div className="deal-hot">
        <div className="deal-header w-full flex bg-orange-100 p-2 justify-between">
          <div className="deal-left flex items-center gap-2">
            <img
            ...
            <div className="timer flex gap-3 items-center">
          ...
          <a
            href="/products"
            className="deal-right bg-orange-500 text-white rounded p-1 text-sm"
          >
            Xem tất cả
          </a>
        </div>
        {allProductsLoading ? (
          ...
          <div className="deal-content products">
                  ...
                  >
                    <Link to={`/products/${item._id}`}>
                      ...
                      <div className="product-title ">
                        ...
                        <p className="sub-title text-xs line-clamp-2">
                          {item.desc_vn}
                        </p>
                      </div>
            ...
            <div className="sub-deal_banner flex gap-1 max-w-full overflow-hidden rounded py-2">
              <img
        ...
        <div className="suggestion-categories my-2">
          ...
          <div className="grid grid-rows-2 grid-cols-8 gap-2">
